...
import MicroConsultation from "./form/microConsultation";
import PhoneInput from "react-phone-input-2";
import "react-phone-input-2/lib/style.css";
import { HelpIn, overAllRatio } from "./common";
import AnimatedCard from "./CommonComponents'/animatedCard";
import { Card } from "./Card";

export const Hero = () => {
  return (
    <>
      <Container className="flex bg-gray-100 flex-wrap mt-10">
        <div className="flex items-start w-full lg:w-2/3 p-5 py-10">
          <div className="max-w-full mb-8">
            <h1 className="text-2xl font-bold font-serif leading-snug tracking-tight text-gray-800 lg:text-5xl lg:leading-tight xl:text-7xl xl:leading-tight dark:text-white">
              Empowering the masses...
            </h1>
            <p className="py-5 text-xl leading-normal font-serif text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              through sensible content & result-driven legal solutions!
            </p>

            <div className="mb-6 max-w-full">
              <h1 className="text-xl font-bold font-serif leading-snug tracking-tight text-gray-800 lg:text-xl lg:leading-tight xl:text-xl xl:leading-tight dark:text-white">
                Talk to the Expert
              </h1>
              <div className="mb-6 flex justify-start w-8/12">
                <div className="flex items-center">
                  ...
                  <div className="w-full px-3">
                    <button
                      type="submit"
                      className="flex p-2  bg-amber-400 text-black font-bold rounded-md hover:bg-amber-600 transition"
                    >
                      <svg
            ...
            <div className="flex flex-wrap py-5 gap-4">
              {overAllRatio?.map((item) => (
                <div key={item?.name} className="flex-none w-64 h-24">
                  <Card item={item} />
                </div>
              ))}
            </div>

            <h1 className="text-xl font-bold font-serif leading-snug tracking-tight text-gray-800 lg:text-xl lg:leading-tight xl:text-xl xl:leading-tight dark:text-white mb-4">
              Some Marquee Users
            </h1>
            <div className="relative flex overflow-x-hidden py-4">
              <div className="animate-marquee whitespace-nowrap">
                <span className="text-1xl mx-4">Marquee Item 1</span>
                <span className="text-1xl mx-4">Marquee Item 2</span>
                <span className="text-1xl mx-4">Marquee Item 3</span>
                <span className="text-1xl mx-4">Marquee Item 4</span>
                <span className="text-1xl mx-4">Marquee Item 5</span>
              </div>
        ...
        <div className="flex  justify-center w-full lg:w-1/3 p-5">
          <MicroConsultation />
        </div>
      </Container>
      ...
      <h2 className="text-5xl font-serif font-extrabold text-center text-gray-800 dark:text-white">
        RTIsolution Team can help you in getting...
      </h2>
      <div className="grid gap-8 mt-10 sm:grid-cols-2 lg:grid-cols-3">
        {HelpIn?.map((item, index) => (
